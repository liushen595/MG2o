<template>
	<view class="container">
		...
		<!-- 消息输入部分 -->
		<view v-if="isLocationVerified" class="message-input-container">
			...
			<button class="record-btn" @click="toggleRecording" :disabled="!isConnected" :class="{recording: isRecording}">
				{{ isRecording ? '停止录音' : '录音' }}
			</button>
		</view>
